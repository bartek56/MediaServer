...
MultimediaConfig::MultimediaConfig(QObject *parent) : QObject(parent), dlnaConfigFile(std::make_unique<ConfigFile>(MINIDLNA_CONFIG_FILE)), mpdConfigFile(std::make_unique<ConfigFile>(MPD_CONFIG_FILE))
{
